...
public partial class ProviderLoginPage : System.Web.UI.Page
{
   ...
   // public string constr = "Server=ehrmysqldb.czolesibiz1g.us-west-2.rds.amazonaws.com;Port=3306;Database=EhrMysqlDb;Uid=admin;Pwd=admin123";
    ...
    protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        Response.Redirect(String.Format("ProviderMyPage.aspx?selection={0}", Server.UrlEncode(selection)));
       Session["selection"] = GridView1.SelectedRow.Cells[1].Text;
    ...
    {
        Response.Redirect("ProviderMyPage.aspx");
    }
}