...
def all_data_insert(data):
    try:
        ...
        cursor.execute("insert into AllData2(FirstName, LastName, Age, Gender, Birthday, Occupation, UserName, Password, Race, Ethnicity, Smoking, Language, SSN, CreditCardNumber, CVV, ExpiryDate, NameonCard, PersonalID)"
